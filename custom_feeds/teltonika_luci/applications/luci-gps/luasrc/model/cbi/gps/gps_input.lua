...
m = Map("gps", translate("GPS I/O Configuration"),	translate(""))

s = m:section(TypedSection, "gps", translate("Check Analog"))

interval = s:option(Value, "analog_interval", translate("Interval [sec]"), translate("Interval to check analog input value"))
interval.default = "5"
...
src = s:option(DummyValue, "input", translate("Input"), translate("Specifies type of GPS rule"))
src.rawhtml = true
src.width   = "10%"
function src.cfgvalue(self, s)
	...
	--return z
	if z == "digital1" then
		return translatef("Digital input")
	elseif z == "digital2" then
		return translatef("Digital isolated input")
...
src = s:option(DummyValue, "priority", translate("Priority"), translate(""))
src.rawhtml = true
src.width   = "10%"
function src.cfgvalue(self, s)
...
src = s:option(DummyValue, "event", translate("Generate event"), translate(""))
src.rawhtml = true
src.width   = "18%"
function src.cfgvalue(self, s)
