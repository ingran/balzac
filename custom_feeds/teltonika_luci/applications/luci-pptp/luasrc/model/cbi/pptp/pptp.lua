...
m = Map("pptpd", translate("Point-to-Point Tuneling Protocol"))
m.spec_dir = nil
--m.pageaction = false


s = m:section( TypedSection, "service", translate("PPTP Configuration"), translate("Below is a list of configured PPTP instances and their current states.") )
s.addremove = true
s.anonymous = true
