...
user = s:option(Value, "username", translate("User name"), translate("User name used for authorization (5 characters minimum)"))
user.datatype = "fieldvalidation('^[a-zA-Z0-9!@#$%&*+-=?_.]+$',5)"
user.rmempty = false
user.default = "user1"

pass = s:option(Value, "password", translate("Password"), translate("Password used for authorization (5 characters minimum)"))
