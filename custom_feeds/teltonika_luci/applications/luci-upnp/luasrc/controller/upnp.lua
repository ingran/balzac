...
function index()
	...
	page = entry({"admin", "services", "upnp"}, cbi("upnp/upnp"), _(translate("UPNP")))
	page.i18n = "upnp"
	page.dependent = true

	page = entry({"mini", "network", "upnp"}, cbi("upnp/upnpmini", {autoapply=true}), _(translate("UPNP")))
	page.i18n = "upnp"
	page.dependent = true
...
function act_delete()
	...
	luci.http.status(400, translate("Bad request"))
end
