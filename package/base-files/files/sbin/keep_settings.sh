...
sim1_list="_method ifname proto apn pincode dialnumber auth_mode username password service device method roaming pdptype"
sim2_cfg="simcard.sim2"
sim2_list="_method ifname proto apn pincode dialnumber auth_mode username password service device method roaming pdptype"
ppp_cfg="network.ppp"
ppp_list="ifname proto apn pincode dialnumber auth_mode username password service method roaming pdptype pppd_options enabled disabled"
