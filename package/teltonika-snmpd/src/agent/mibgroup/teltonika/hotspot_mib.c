 ...
 */
oid hotspot1_variables_oid[] = { 1, 3, 6, 1, 4, 1, 99999, 3, 1};
oid hotspot2_variables_oid[] = { 1, 3, 6, 1, 4, 1, 99999, 3, 2};
oid hotspot3_variables_oid[] = { 1, 3, 6, 1, 4, 1, 99999, 3, 3};
oid hotspot4_variables_oid[] = { 1, 3, 6, 1, 4, 1, 99999, 3, 4};
/*
...
u_char* var_hotspot1(struct variable *vp, oid *name, size_t *length, int exact, size_t *var_len, WriteMethod **write_method)
{
	...
	case HOTSPOTDOWNLOAD:
		if (get_params("downloadbandwidth", search_result, 1, 1) != 0)
			strncpy(search_result, "unknown", sizeof("unknown"));
		*var_len = strlen(search_result);
		*write_method = 0;
		return (u_char *) search_result;
	...
	case HOTSPOTUPLOAD:
		if (get_params("uploadbandwidth", search_result, 1, 1) != 0)
			strncpy(search_result, "unknown", sizeof("unknown"));
		*var_len = strlen(search_result);
		*write_method = 0;
		return (u_char *) search_result;
