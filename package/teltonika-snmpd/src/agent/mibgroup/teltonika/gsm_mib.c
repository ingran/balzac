...
struct variable1 gsm_variables2[] = {
	...
	{TEMP,		ASN_OCTET_STR, RONLY, var_gsm, 1, {9}},
	{RXCOUNTT,	ASN_OCTET_STR, RONLY, var_gsm, 1, {10}},
	{TXCOUNTT,	ASN_OCTET_STR, RONLY, var_gsm, 1, {11}},
	{RXCOUNTY,	ASN_OCTET_STR, RONLY, var_gsm, 1, {12}},
	{TXCOUNTY,	ASN_OCTET_STR, RONLY, var_gsm, 1, {13}},
	{FWVERSION,	ASN_OCTET_STR, RONLY, var_gsm, 1, {14}},
	{SIMSLOT,	ASN_OCTET_STR, RONLY, var_gsm, 1, {15}},
	{ROUTERUPTIME,		ASN_OCTET_STR, RONLY, var_gsm, 1, {16}},
	{CONNECTIONUPTIME,	ASN_OCTET_STR, RONLY, var_gsm, 1, {17}},
	{MOBILEIP,	ASN_OCTET_STR, RONLY, var_gsm, 1, {18}},
	{SENT,		ASN_OCTET_STR, RONLY, var_gsm, 1, {19}},
	{RECEIVED,	ASN_OCTET_STR, RONLY, var_gsm, 1, {20}},
 ...
 */
oid gsm_variables_oid[] = { 1, 3, 6, 1, 4, 1, 99999, 1};
oid gsm_variables_oid2[] = { 1, 3, 6, 1, 4, 1, 99999, 2};
oid gsm_variables_oid3[] = { 1, 3, 6, 1, 4, 1, 99999, 5};
/*
...
void init_gsm_mib(void)
{
	 ...
	 */
	REGISTER_MIB("teltonika", gsm_variables1, variable1, gsm_variables_oid);
	REGISTER_MIB("teltonika", gsm_variables2, variable1, gsm_variables_oid2);
	REGISTER_MIB("teltonika", gsm_variables3, variable1, gsm_variables_oid3);
}
...
u_char* var_gsm(struct variable *vp, oid *name, size_t *length, int exact, size_t *var_len, WriteMethod **write_method)
{
	...
	case SERIAL:
		if (get_param("--serial", search_result, 5) != 0)
			strncpy(search_result, "unknown", sizeof("unknown"));
		*var_len = strlen(search_result);
		*write_method = 0;
		return (u_char *) search_result;
