...
#elif defined(CONFIG_FOR_TLT_RUT900)
	if (gpio & (1 << GPIO_LAN1_LED_BIT))
		gpio = 1 << GPIO_LAN2_LED_BIT;
	else if (gpio & (1 << GPIO_LAN2_LED_BIT))
		gpio = 1 << GPIO_LAN3_LED_BIT;
	else if (gpio & (1 << GPIO_LAN3_LED_BIT))
		gpio = 1 << GPIO_LAN4_LED_BIT;
	else
		gpio = 1 << GPIO_LAN1_LED_BIT;
#else
...
void led_toggle_invert(void){
	unsigned int gpio;

	gpio = ar7240_reg_rd(AR934X_GPIO_OUT);

	if (!(gpio & (1 << GPIO_LAN1_LED_BIT)))
		gpio = (1 << GPIO_LAN1_LED_BIT) | (1 << GPIO_LAN3_LED_BIT) | (1 << GPIO_LAN4_LED_BIT);
	else if (!(gpio & (1 << GPIO_LAN2_LED_BIT)))
		gpio = (1 << GPIO_LAN1_LED_BIT) | (1 << GPIO_LAN2_LED_BIT) | (1 << GPIO_LAN4_LED_BIT);
	else if (!(gpio & (1 << GPIO_LAN3_LED_BIT)))
		gpio = (1 << GPIO_LAN1_LED_BIT) | (1 << GPIO_LAN2_LED_BIT) | (1 << GPIO_LAN3_LED_BIT);
	else
		gpio = (1 << GPIO_LAN2_LED_BIT) | (1 << GPIO_LAN3_LED_BIT) | (1 << GPIO_LAN4_LED_BIT);
