 ...
 *	Copyright 2016 JSC Teltonika <gpl@teltonika.lt>.
 */
...
int do_http_upgrade(const ulong size, const int upgrade_type){
	...
	} else if(upgrade_type == WEBFAILSAFE_UPGRADE_TYPE_DATABASE){

		printf("\n\n************************\n*    DATABASE DELETE    *\n* DO NOT POWER OFF DEVICE! *\n************************\n\n");
		sprintf(buf,
				"erase 0x%lX +0x%lX",
				WEBFAILSAFE_UPLOAD_DATABASE_ADDRESS,
				WEBFAILSAFE_UPLOAD_DATABASE_SIZE_IN_BYTES);
